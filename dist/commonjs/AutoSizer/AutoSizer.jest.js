...
describe('AutoSizer', function () {
  function getMarkup() {
    var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      roundingMode = _ref2$roundingMode === void 0 ? undefined : _ref2$roundingMode,
  ...
  function _simulateResize() {
    _simulateResize = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(_ref5) {
      var element, height, width, trigger;
      return _regenerator["default"].wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            element = _ref5.element, height = _ref5.height, width = _ref5.width;
            mockOffsetSize(width, height);
  ...
  describe('onResize and (re)render', function () {
    ...
    it('should only trigger when height changes for disableWidth == true', /*#__PURE__*/function () {
      var _ref8 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee3(done) {
        var onResize, ChildComponent, rendered;
    ...
    it('should only trigger when width changes for disableHeight == true', /*#__PURE__*/function () {
      var _ref9 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee4(done) {
        var onResize, ChildComponent, rendered;
