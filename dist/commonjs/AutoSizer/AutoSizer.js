...
var _getEffectiveZoom = _interopRequireDefault(require("../utils/getEffectiveZoom"));
...
var ROUNDING_FNS /*: {[RoundingMode]: (number) => number}*/ = {
  ceil: Math.ceil,
  floor: Math.floor,
  round: Math.round
};
  ...
  function AutoSizer() {
    ...
    (0, _defineProperty2["default"])(_this, "_onResize", function () {
      var _this$props = _this.props,
        ...
        roundingMode = _this$props.roundingMode;
      if (_this._parentNode) {
        ...
        var round = ROUNDING_FNS[roundingMode] || Math.ceil;
        var boundingRect = _this._parentNode.getBoundingClientRect();
        ...
        var zoom = (0, _getEffectiveZoom["default"])(_this._parentNode) || 1;
        var height = round(boundingRect.height / zoom) || 0;
        var width = round(boundingRect.width / zoom) || 0;
